    ...
    controller.getVideoThumbnail = function(item) {
        ...
        switch (item.assetType) {
            case 'youtube':
                ...
                videoThumbnailCache[item._id] = 'https://img.youtube.com/vi/' + details.id + '/mqdefault.jpg';
                break;
            case 'vimeo':
                ...
                $http.get("https://vimeo.com/api/v2/video/" + id + ".json", {
                    ...
                    videoThumbnailCache[item._id] = res.data[0].thumbnail_small;
                })
                break;
            case 'upload':
                break;
